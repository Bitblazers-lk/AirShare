function InitPhotoEditor() {
    ...
    document.getElementById("photo-edit-area").appendChild($photo_editor_box);
    $photo_editor_box.appendChild($container);

    var img = document.getElementsByClassName('image-view')[0];
    var photoeditor_box = document.getElementById("photo-edit-area").getElementsByClassName('pe_container1')[0];
